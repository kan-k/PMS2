...
#     fit.ridge.pca <- cv.glmnet(sub.dat[,var.sel],age_tab$age, alpha=0) #fixing lambda  #fixing lambda
...
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_ridge'))
# 
...
# mask.temp@datatype = 16
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_ridge_rank'))
...
# mask.temp@datatype = 16
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_PCA'))
# 
# ###
...
# mask.temp@datatype = 16
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_PCA_rank'))
# 
...
# mask.temp@datatype = 16
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_SPCA'))
# 
# ###
# var.sel <- (order(abs(beta_pms), decreasing=TRUE))
# mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
...
# mask.temp@datatype = 16
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_SPCA_rank'))
# 
# ####Removing previous data
# remove(lambda.80)
# remove(pre_beta_pms)
...
# write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/oct29_age_pms_full.csv'), row.names = FALSE)
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_cor_fit'))
...
# 
# write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/oct29_age_nbpms_full.csv'), row.names = FALSE)
# 
# #plot out.pms.hi
# mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
...
# mask.temp@datatype = 16
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_pms_hi'))
# 
# #plot out.pms.holp
# mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
...
# mask.temp@datatype = 16
# mask.temp@bitpix = 32
# writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_pms_holp'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_ridge'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_ridge_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_PCA'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_PCA_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_PCA_proj'))
var.sel <- (order(abs(beta_pms), decreasing=TRUE))
mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
mask.temp[mask.temp!=0][var.sel] <- c(ncol(sub.dat):1)/ncol(sub.dat)
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_PCA_proj_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_PCA_cov'))
var.sel <- (order(abs(beta_pms), decreasing=TRUE))
mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
mask.temp[mask.temp!=0][var.sel] <- c(ncol(sub.dat):1)/ncol(sub.dat)
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_PCA_cov_rank'))
########################################
####Removing previous data
remove(lambda.80)
remove(pre_beta_pms)
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_SPCA'))
var.sel <- (order(abs(beta_pms), decreasing=TRUE))
mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
mask.temp[mask.temp!=0][var.sel] <- c(ncol(sub.dat):1)/ncol(sub.dat)
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_SPCA_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_SPCA_proj'))
var.sel <- (order(abs(beta_pms), decreasing=TRUE))
mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
mask.temp[mask.temp!=0][var.sel] <- c(ncol(sub.dat):1)/ncol(sub.dat)
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_SPCA_proj_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_SPCA_cov'))
var.sel <- (order(abs(beta_pms), decreasing=TRUE))
mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
mask.temp[mask.temp!=0][var.sel] <- c(ncol(sub.dat):1)/ncol(sub.dat)
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth_SPCA_cov_rank'))
...
out <- rbind(res.ridge$train,res.lambda.pca.90$train,res.lambda.spca.90$train,res.lambda.pca.90.p$train,res.lambda.spca.90.p$train , res.lambda.pca.90.c$train,res.lambda.spca.90.c$train,
             res.ridge$test,res.lambda.pca.90$test,res.lambda.spca.90$test,res.lambda.pca.90.p$test,res.lambda.spca.90.p$test,res.lambda.pca.90.c$test,res.lambda.spca.90.c$test)

write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/oct29_age_pms90_smooth_shrink.csv'), row.names = FALSE)
