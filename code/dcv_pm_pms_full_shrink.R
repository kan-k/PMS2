...
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sep9_pm_dcv_smooth_PCA90_proj'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sep9_pm_dcv_smooth_PCA90_cov'))
########################################
####Removing previous data
remove(lambda.80)
remove(pre_beta_pms)
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sep9_pm_dcv_smooth_PCA90_corr'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sep9_pm_dcv_smooth_SPCA90_proj'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sep9_pm_dcv_smooth_SPCA90_cov'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sep9_pm_dcv_smooth_SPCA90_corr'))
...
write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sep9_pm_dcv_pms90_smooth_shrink.csv'), row.names = FALSE)
