...
res.var.full <- sub.dat[,mask.signal] %*% mask.beta[mask.signal]
...
for(q in (1:length(noise.strs))){
  ...
  rsquare <- rsquares[q]
  # set.seed(4)
  res.var.full <- res.var.full + rnorm(length(res.var.full), 0, sqrt(noise.strs.diff[q]))
  res.var.test <- res.var.test + rnorm(length(res.var.test), 0, sqrt(noise.strs.diff[q]))
  
  
  
  for(training_subset in 1:10){
    trainset.ind <- sample(1:nrow(sub.dat.full),nrow(sub.dat.full)/2, replace = FALSE)
    sub.dat <- sub.dat.full[trainset.ind,]
    res.var <- res.var.full[trainset.ind]
  ...
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_PCA90'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_PCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_SPCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_SPCA90'))
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_oct3_stability_binmask_str',rsquare,'_set',training_subset,'_pms90.csv'), row.names = FALSE)
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_oct3_stability_binmask_str',rsquare,'_set',training_subset,'_nbpms.csv'), row.names = FALSE)
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_pmshi'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_holp'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_PCA90_smooth_proj'))
  ###
  # var.sel<- as.numeric(c(rank_beta_pms))
  var.sel <- (order(abs(beta_pms), decreasing=TRUE))
  mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/pms2/sub150_centre_mask.nii.gz')
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_PCA90_smooth_proj'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_PCA90_smooth_cov'))
  ###
  # var.sel<- as.numeric(c(rank_beta_pms))
  var.sel <- (order(abs(beta_pms), decreasing=TRUE))
  mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/pms2/sub150_centre_mask.nii.gz')
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_PCA90_smooth_cov'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_SPCA90_smooth_proj'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_SPCA90_smooth_proj'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_SPCA90_smooth_cov'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_SPCA90_smooth_cov'))
  
  ###
  out <- rbind(res.lambda.pca.90$train,res.lambda.spca.90$train,res.ridge$train, 
               res.lambda.pca.90$test,res.lambda.spca.90$test,res.ridge$test)
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_oct3_stability_binmask_str',rsquare,'_set',training_subset,'_pms90_smooth.csv'), row.names = FALSE)
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_oct3_stability_binmask_str',rsquare,'_set',training_subset,'_pms90_smooth_shrink.csv'), row.names = FALSE)  
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_str',rsquare,'_set',training_subset,'_tmap'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/oct3_stability_binmask_rank_str',rsquare,'_set',training_subset,'_tmap'))
