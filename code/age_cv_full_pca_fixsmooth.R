...
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_ridge'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_ridge_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_PCA'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_PCA_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_PCA_proj'))
var.sel <- (order(abs(beta_pms), decreasing=TRUE))
mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
mask.temp[mask.temp!=0][var.sel] <- c(ncol(sub.dat):1)/ncol(sub.dat)
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_PCA_proj_rank'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_PCA_cov'))
var.sel <- (order(abs(beta_pms), decreasing=TRUE))
mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/res3mask.nii.gz')
mask.temp[mask.temp!=0][var.sel] <- c(ncol(sub.dat):1)/ncol(sub.dat)
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/oct29_age_smooth',smoothing.sigma,'_PCA_cov_rank'))
########################################
####Removing previous data
remove(lambda.80)
remove(pre_beta_pms)
...
write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/oct29_age_pms90_smooth',smoothing.sigma,'_shrink_pca.csv'), row.names = FALSE)
