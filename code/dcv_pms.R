...
write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/apr23_dcv_pms.csv'), row.names = FALSE)
...
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/apr23_robpca_pms'))
