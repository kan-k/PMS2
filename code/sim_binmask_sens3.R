...
for(q in (1:length(signal.strs))){
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_str',signal.str,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_str',signal.str,'_PCA90'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_PCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_str',signal.str,'_SPCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_SPCA90'))
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_sep5_500_binmask_str',signal.str,'_pms90.csv'), row.names = FALSE)
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_sep5_500_binmask_str',signal.str,'_nbpms.csv'), row.names = FALSE)
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_pmshi'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_holp'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_3_str',signal.str,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_3_rank_str',signal.str,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_3_str',signal.str,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_3_rank_str',signal.str,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_str',signal.str,'_PCA90_smooth_proj'))
  ###
  # var.sel<- as.numeric(c(rank_beta_pms))
  var.sel <- (order(abs(beta_pms), decreasing=TRUE))
  mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/pms2/sub150_centre_mask.nii.gz')
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_PCA90_smooth_proj'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_3_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_3_rank_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_str',signal.str,'_SPCA90_smooth_proj'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_SPCA90_smooth_proj'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_str',signal.str,'_SPCA90_smooth_cov'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_SPCA90_smooth_cov'))
  
  ###
  out <- rbind(res.lambda.pca.90$train,res.lambda.spca.90$train,res.ridge$train, 
               res.lambda.pca.90$test,res.lambda.spca.90$test,res.ridge$test)
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_sep5_500_binmask_3_str',signal.str,'_pms90_smooth.csv'), row.names = FALSE)
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_sep5_500_binmask_3_str',signal.str,'_pms90_smooth_shrink.csv'), row.names = FALSE)  
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_str',signal.str,'_tmap'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep5_500_binmask_rank_str',signal.str,'_tmap'))
