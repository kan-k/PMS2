...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/aug2_sub_PCA90'))
###
mu = colMeans(sub.dat)
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/aug2_sub_mu_PCA90'))
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/aug2_sub_SPCA90'))
###
...
mask.temp@datatype = 16
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/aug2_sub_mu_SPCA90'))
...
write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/aug2_mu_cv_pms90_sub150.csv'), row.names = FALSE)
