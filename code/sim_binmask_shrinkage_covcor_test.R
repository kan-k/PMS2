...
###sep4 v2 ==> using Cov and Corr approx rather than proj matrix ==> _6_ and _7_ for cov, and _8_ for corr
...
for(q in (1:length(signal.strs))){
  ...
  print("tune pca 90")
  lambda.80 <- pca$rotation[, 1:num_components.90] %*% diag(pca$sdev[1:num_components.90]^2) %*% t(pca$rotation[, 1:num_components.90])
  ...
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_6_str',signal.str,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_6_rank_str',signal.str,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_6_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_6_rank_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_7_str',signal.str,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_7_rank_str',signal.str,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_7_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_7_rank_str',signal.str,'_SPCA90_smooth'))
  ################################################################   ################################################################ 
  print("Correlation Fix shrinkage ########")
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_8_str',signal.str,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_8_rank_str',signal.str,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_8_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/sep3_500_binmask_8_rank_str',signal.str,'_SPCA90_smooth'))
