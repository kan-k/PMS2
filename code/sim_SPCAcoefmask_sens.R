...
#previous versuin of SPCA coef mask basically keep adding the signal 6 times (not corresponding to assigned signal)
...
mask.coef <- c(fast_read_imgs_mask('/well/nichols/users/qcv214/pms2/viz/sim/aug21_500_age_coef_SPCA90_smooth.nii.gz','/well/nichols/users/qcv214/pms2/sub150_centre_mask.nii.gz'))
...
for(q in (1:length(signal.strs))){
  ...
  print("here 4")
  ####Calling mmand
  sub.dat[,mask.signal] <- t(t(sub.dat[,mask.signal]) + mask.coef[mask.signal]*signal.str)
  
  sub.dat.test[,mask.signal] <- t(t(sub.dat.test[,mask.signal]) + mask.coef[mask.signal]*signal.str)
  ...
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_str',signal.str,'_meantrainingdata'))
  
  mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/pms2/sub150_centre_mask.nii.gz')
  mask.temp[mask.temp!=0] <- colMeans(sub.dat.test)
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_str',signal.str,'_meantestdata'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_str',signal.str,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_rank_str',signal.str,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_str',signal.str,'_PCA90'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_rank_str',signal.str,'_PCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_str',signal.str,'_SPCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_rank_str',signal.str,'_SPCA90'))
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug30_500_SPCAcoefmask_str',signal.str,'_pms90.csv'), row.names = FALSE)
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug30_500_SPCAcoefmask_str',signal.str,'_nbpms.csv'), row.names = FALSE)
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_rank_str',signal.str,'_pmshi'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_rank_str',signal.str,'_holp'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_3_str',signal.str,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_3_rank_str',signal.str,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_3_str',signal.str,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_3_rank_str',signal.str,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_3_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_3_rank_str',signal.str,'_SPCA90_smooth'))
  
  ###
  out <- rbind(res.lambda.pca.90$train,res.lambda.spca.90$train,res.ridge$train, 
               res.lambda.pca.90$test,res.lambda.spca.90$test,res.ridge$test)
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug30_500_SPCAcoefmask_3_str',signal.str,'_pms90_smooth.csv'), row.names = FALSE)
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_2_str',signal.str,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_2_rank_str',signal.str,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_2_str',signal.str,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_2_rank_str',signal.str,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_2_str',signal.str,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_2_rank_str',signal.str,'_SPCA90_smooth'))
  
  ###
  out <- rbind(res.lambda.pca.90$train,res.lambda.spca.90$train,res.ridge$train, 
               res.lambda.pca.90$test,res.lambda.spca.90$test,res.ridge$test)
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug30_500_SPCAcoefmask_2_str',signal.str,'_pms90_smooth.csv'), row.names = FALSE)
  ...
  pval_mask@bitpix <- 32
  writeNIfTI(pval_mask, paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_str', signal.str, '_pvalmap'))
  ...
  writeNIfTI(sig_voxels, paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug30_500_SPCAcoefmask_str', signal.str, '_pvalthresmap'))
