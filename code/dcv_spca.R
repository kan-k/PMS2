...
######scaling data for ridge fitting and SPCA
...
lambda <- pca$rotation%*% t(pca$rotation)
#######
print(paste0("dim ROBPCA: ", dim(pca$rotation)))
# pca <-  prcomp(sub.dat)
...
write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/may9_dcv_spca.csv'), row.names = FALSE)
...
mask.temp@bitpix = 32
writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/may9_spca_pms'))
