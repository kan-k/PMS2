...
trainset.ind2 <- setdiff(1:nrow(sub.dat.full),trainset.ind)

trainset <- list(a = trainset.ind, b = trainset.ind2)

for(signal.str in signal.strs){
  
  for(training_subset in 1:2){
  
  sub.dat <- sub.dat.full[trainset[[training_subset]],]  
  ...
  # mask.temp@bitpix = 32
  # writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_str',signal.str,'_set',training_subset,'_meantrainingdata'))
  # 
  # mask.temp <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/pms2/sub150_centre_mask.nii.gz')
  # mask.temp[mask.temp!=0] <- colMeans(sub.dat.test)
  # mask.temp@datatype = 16
  # mask.temp@bitpix = 32
  # writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_str',signal.str,'_set',training_subset,'_meantestdata'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_str',signal.str,'_set',training_subset,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_rank_str',signal.str,'_set',training_subset,'_ridge'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_str',signal.str,'_set',training_subset,'_PCA90'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_rank_str',signal.str,'_set',training_subset,'_PCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_str',signal.str,'_set',training_subset,'_SPCA90'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_rank_str',signal.str,'_set',training_subset,'_SPCA90'))
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug20_stability_binmask_str',signal.str,'_set',training_subset,'_pms90.csv'), row.names = FALSE)
  ...
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug20_stability_binmask_str',signal.str,'_set',training_subset,'_nbpms.csv'), row.names = FALSE)
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_rank_str',signal.str,'_set',training_subset,'_pmshi'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_rank_str',signal.str,'_set',training_subset,'_holp'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_3_str',signal.str,'_set',training_subset,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_3_rank_str',signal.str,'_set',training_subset,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_3_str',signal.str,'_set',training_subset,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_3_rank_str',signal.str,'_set',training_subset,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_3_str',signal.str,'_set',training_subset,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_3_rank_str',signal.str,'_set',training_subset,'_SPCA90_smooth'))
  
  ###
  out <- rbind(res.lambda.pca.90$train,res.lambda.spca.90$train,res.ridge$train, 
               res.lambda.pca.90$test,res.lambda.spca.90$test,res.ridge$test)
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug20_stability_binmask_3_str',signal.str,'_set',training_subset,'_pms90_smooth.csv'), row.names = FALSE)
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_2_str',signal.str,'_set',training_subset,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_2_rank_str',signal.str,'_set',training_subset,'_ridge_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_2_str',signal.str,'_set',training_subset,'_PCA90_smooth'))
  ###
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_2_rank_str',signal.str,'_set',training_subset,'_PCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_2_str',signal.str,'_set',training_subset,'_SPCA90_smooth'))
  ...
  mask.temp@datatype = 16
  mask.temp@bitpix = 32
  writeNIfTI(mask.temp,paste0('/well/nichols/users/qcv214/pms2/viz/sim/aug20_stability_binmask_2_rank_str',signal.str,'_set',training_subset,'_SPCA90_smooth'))
  
  ###
  out <- rbind(res.lambda.pca.90$train,res.lambda.spca.90$train,res.ridge$train, 
               res.lambda.pca.90$test,res.lambda.spca.90$test,res.ridge$test)
  write.csv(out,paste0( '/well/nichols/users/qcv214/pms2/pile/sim_aug20_stability_binmask_2_str',signal.str,'_set',training_subset,'_pms90_smooth.csv'), row.names = FALSE)
  }
}